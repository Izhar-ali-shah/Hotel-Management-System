...
<body >
    ...
    <br>
        ...
        <div class="heading">
        <h1 class="head">MESS  <span>INFORMATION</span></h1>
        </div>    
        <div >
        <div class="table">
    ...
    <tbody>
        ...
        while($row = $result -> fetch_assoc())
        {
            echo "<tr>
                ...
                <td>  <button class='btn btn-primary'><a href='update_mess.html' class ='text-light'> Update </a> </button> </td>
