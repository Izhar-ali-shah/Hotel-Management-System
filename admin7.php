...
<head>
    ...
    <link rel="stylesheet" href="admin7.css">
...
<body >
    ...
    <br>
        ...
        <div class="heading">
        <h1 class="head">SALARYS  <span>INFORMATION</span></h1>
        </div>    
        <div >
        <div class="table">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM salary NATURAL JOIN employee ORDER BY emp_id";
        ...
        while($row = $result -> fetch_assoc())
        {
            echo "<tr>
                ...
                <td>" . $row["increment_yearly_salary"] . "</td>
                <td>" . $row["bonus_salary"] . "</td>
