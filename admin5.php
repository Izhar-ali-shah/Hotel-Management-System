...
<head>
    ...
    <link rel="stylesheet" href="adm5.css">
...
<body >
    ...
    <br>
        ...
        <div class="heading">
        <h1 class="head">ROOMS  <span>INFORMATION</span></h1>
        </div>    
        <div >
        <div class="table">
    ...
    <tbody>
        ...
        $sql = "SELECT * FROM rooms NATURAL JOIN student_info ORDER BY room_id";
        ...
        while($row = $result -> fetch_assoc())
        {
            ...
            <td>  <button class='btn btn-primary'><a href='change_room.html' class ='text-light'> Update </a> </button> </td>
        </tr>";
        }
